...
Eleven color themes ship installed, in light and dark variants where the palette has both: True
Black, Dracula, Gruvbox, One, Catppuccin, Tokyo Night, Monokai, Nord, Solarized, Hackerman and
Solitude. Custom themes gained success, warning, error and info colors, and are shareable with a
single theme code.
