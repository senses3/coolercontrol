...
mode, setup wizards, and a faster daemon. Here is what's new.
...
and how duty maps to RPM. Firmware-controlled fans are mapped too, and a calibrated fan can be
converted to true duty with one click.
