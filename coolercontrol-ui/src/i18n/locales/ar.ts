...
export default {
    ...
    layout: {
        shell: {
            ...
            simple: {
                ...
                seedMessage:
                    'إنشاء منحنى لـ {channel} يبدأ من سرعتها الحالية {duty}%.\n\nاضبط شكله في المحرر بالأسفل.',
                sharedSummary:
    ...
    components: {
        ...
        onboarding: {
            ...
            simpleHome: 'الرئيسية',
            simpleHomeDesc:
                'حالة الخدمة وسلامة الأجهزة في لمحة، إضافة إلى السجلات وتقرير العتاد الذي تُرسله عندما لا يُكتشف شيء ما.',
            simpleFans: 'المراوح',
            simpleFansDesc:
                'كل مروحة ومضخة يستطيع CoolerControl التحكم بها. افتح واحدة لتمنحها منحنى، أو تثبّت سرعتها، أو تتركها للبرنامج الثابت.',
            simpleSensors: 'المستشعرات',
            simpleSensorsDesc:
                'كل قراءات الحرارة والمراوح والطاقة في النظام. افتح واحدة لعرض سجلها الأخير.',
            interfaceMode: 'الواجهة',
            interfaceModeDesc:
                'بدّل بين الواجهة البسيطة والكاملة من هنا في أي وقت. لا يضيع شيء في الحالتين: كلتاهما تعملان على الإعدادات نفسها.',
            chooseInterface: 'أي واجهة تفضّل؟',
            simpleChoiceDesc: 'منحنيات المراوح والمستشعرات فقط.',
            fullChoiceDesc:
                'كل شيء: الملفات الشخصية والدوال ولوحات المعلومات والتنبيهات والأوضاع والإضاءة والمزيد.',
            gettingStartedIntro:
