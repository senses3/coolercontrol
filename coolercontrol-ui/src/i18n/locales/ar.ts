...
export default {
        ...
        shell: {
            ...
            coolingPage: {
                ...
                convert: {
                    ...
                    confirmProfile:
                        "إنشاء نسخة من '{profile}' للقناة {channel} مع تحويل سرعاتها، وتعيين النسخة لهذه المروحة. يبقى '{profile}' دون تغيير. لا تفعل ذلك إلا للسرعات التي ضبطتها قبل معايرة هذه المروحة؛ فتحويل القيم مرتين يجعل المروحة تعمل بسرعة خاطئة.",
                    confirmManual:
                        'تحويل الدورة اليدوية للقناة {channel} لتحافظ المروحة على السرعة التي كانت عليها قبل المعايرة. لا تفعل ذلك إلا لقيمة ضبطتها قبل معايرة هذه المروحة؛ فالتحويل مرتين يجعل المروحة تعمل بسرعة خاطئة.',
                    accept: 'تحويل',
    ...
    components: {
        ...
        onboarding: {
            ...
            startTourAgain: 'يمكنك بدء هذه الجولة مرة أخرى في أي وقت من الصفحة الرئيسية.',
            startTour: 'بدء الجولة',
