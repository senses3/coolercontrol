...
export default {
    ...
    layout: {
        shell: {
            ...
            plugins: '插件',
            modes: '模式',
            sectionPlaceholder: '此部分将在界面重新设计的第 {phase} 阶段推出。',
            panelPlaceholder: '此部分内容将在第 {phase} 阶段推出。',
            laterPhase: '将在后续阶段移至此处',
            manageModes: '管理模式',
            access: '访问',
            power: '电源',
            noModes: '尚未保存模式',
    ...
    components: {
        ...
        onboarding: {
            ...
            home: '主页',
            homeDesc:
                '您的着陆页：一目了然地查看后台服务状态和设备健康，以及日志、应用信息、有用链接和压力测试工具。',
            cooling: '冷却',
