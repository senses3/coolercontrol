...
export default {
    ...
    layout: {
        shell: {
            ...
            plugins: '外掛',
            modes: '模式',
            sectionPlaceholder: '此區段將在 UI 改版的第 {phase} 階段推出。',
            panelPlaceholder: '區段內容將在第 {phase} 階段推出。',
            laterPhase: '將在後續階段移至此處',
            manageModes: '管理模式',
            access: '存取',
            power: '電源',
            noModes: '尚未儲存模式',
    ...
    components: {
        ...
        onboarding: {
            ...
            home: '首頁',
            homeDesc:
                '您的首頁：一眼掌握後台服務狀態與裝置健康，還有日誌、應用資訊、實用連結和壓力測試工具。',
            cooling: '冷卻',
