...
export default {
    ...
    layout: {
        shell: {
            ...
            plugins: 'Plugins',
            modes: 'Modos',
            sectionPlaceholder: 'Esta seção chega na fase {phase} da reformulação da interface.',
            panelPlaceholder: 'O conteúdo da seção chega na fase {phase}.',
            laterPhase: 'Será movido para cá em uma fase posterior',
        ...
        settings: {
            ...
            tooltips: {
                ...
                exportThemeFile:
                    'Salva o tema personalizado atual em um arquivo JSON que você pode guardar ou compartilhar.',
                importThemeFile:
                    'Carrega um tema personalizado a partir de um arquivo JSON no disco.',
            },
    ...
    views: {
        ...
        alerts: {
            range: 'Intervalo: {min} a {max}{unit}',
            since: 'desde {time}',
        ...
        functions: {
            ...
            functionTypeTooltip:
                'Tipos de função:<br/>- <b>Identidade</b>: Aplica limites de tamanho de passo mas de resto passa o valor do perfil inalterado.<br/>- <b>Padrão</b>: Aplica limites de tamanho de passo e configurações de histerese para controle preciso do tempo de resposta e estabilidade do ventilador.<br/>- <b>Média Móvel Exponencial</b>: Suaviza flutuações de temperatura usando uma média ponderada. Mais simples mas menos preciso que Padrão.',
