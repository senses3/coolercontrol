...
export default {
        ...
        shell: {
            ...
            coolingPage: {
                ...
                fork: {
                    ...
                    confirmMessage:
                        "{channel} के लिए '{profile}' की एक प्रति बनाएँ और इस पंखे को सौंपें। '{profile}' और इसका उपयोग करने वाले अन्य पंखे अपरिवर्तित रहते हैं, इसलिए यहाँ किए गए बदलाव केवल {channel} को प्रभावित करेंगे।",
                    accept: 'फोर्क करें',
                },
                convert: {
                    ...
                    confirmProfile:
                        "'{profile}' की एक प्रति {channel} के लिए बदली हुई गतियों के साथ बनाएँ और वह प्रति इस फैन को सौंपें। '{profile}' अपरिवर्तित रहता है। यह केवल उन गतियों के लिए करें जो आपने इस फैन के कैलिब्रेशन से पहले सेट की थीं; मानों को दो बार बदलने पर फैन गलत गति पर चलेगा।",
                    confirmManual:
                        '{channel} की मैन्युअल ड्यूटी बदलें ताकि फैन वही गति बनाए रखे जो कैलिब्रेशन से पहले थी। यह केवल उस मान के लिए करें जो आपने इस फैन के कैलिब्रेशन से पहले सेट किया था; दो बार बदलने पर फैन गलत गति पर चलेगा।',
                    accept: 'बदलें',
    ...
    components: {
        ...
        onboarding: {
            ...
            startTourAgain: 'आप इस टूर को कभी भी होम पेज से दोबारा शुरू कर सकते हैं।',
            startTour: 'टूर शुरू करें',
            maybeLater: 'बाद में',
