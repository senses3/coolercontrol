...
export default {
    ...
    layout: {
        shell: {
            ...
            simple: {
                ...
                seedMessage:
                    '{channel} के लिए एक कर्व बनाएं जो उसकी वर्तमान गति {duty}% से शुरू होता है।\n\nनीचे दिए संपादक में इसे आकार दें।',
                sharedSummary:
    ...
    components: {
        ...
        onboarding: {
            ...
            simpleHome: 'होम',
            simpleHomeDesc:
                'डेमन स्थिति और डिवाइस स्वास्थ्य एक नज़र में, साथ ही लॉग और हार्डवेयर रिपोर्ट, जब कुछ पहचाना न जाए तो भेजने के लिए।',
            simpleFans: 'पंखे',
            simpleFansDesc:
                'हर पंखा और पंप जिसे CoolerControl नियंत्रित कर सकता है। किसी एक को खोलकर उसे कर्व दें, निश्चित गति पर रखें, या फर्मवेयर पर छोड़ दें।',
            simpleSensors: 'सेंसर',
            simpleSensorsDesc:
                'सिस्टम के सभी तापमान, पंखा और पावर रीडिंग। इतिहास देखने के लिए किसी एक को खोलें।',
            interfaceMode: 'इंटरफ़ेस',
            interfaceModeDesc:
                'सरल और पूर्ण इंटरफ़ेस के बीच यहां कभी भी स्विच करें। किसी भी तरह कुछ नहीं खोता: दोनों एक ही सेटिंग्स चलाते हैं।',
            chooseInterface: 'आप कौन सा इंटरफ़ेस चाहेंगे?',
            simpleChoiceDesc: 'पंखे के कर्व और सेंसर, और कुछ नहीं।',
            fullChoiceDesc:
                'सब कुछ: प्रोफ़ाइल, फ़ंक्शन, डैशबोर्ड, अलर्ट, मोड, लाइटिंग और भी बहुत कुछ।',
            gettingStartedIntro:
