...
export default {
    ...
    layout: {
        ...
        coolingPage: {
            ...
            selectTempSource: 'Select a temperature source',
            selectTempSourceHint:
                'Choose the temperature sensor this profile reacts to. The curve editor appears once a source is selected.',
            sharedWith: 'Shared with {count} more',
            sharedTooltip: 'This profile also drives other channels.',
            sharedEditPrompt: 'This profile is used by other channels. Apply your edits to:',
            ...
            activeMode: 'Active',
            activate: 'Activate',
            noModes: 'No modes saved yet. Modes snapshot all channel settings for quick switching.',
            chain: {
