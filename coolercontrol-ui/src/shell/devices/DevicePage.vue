    ...
    <div class="flex h-full flex-col overflow-y-auto p-4">
        ...
        <template v-else-if="device != null">
            ...
            <button
                ...
                type="button"
                class="mt-3 inline-flex h-10 w-fit items-center gap-2 rounded-lg border border-error/40 bg-control px-4 text-base font-medium text-text-color outline-none transition-colors hover:bg-error/10 focus-visible:ring-2 focus-visible:ring-accent"
