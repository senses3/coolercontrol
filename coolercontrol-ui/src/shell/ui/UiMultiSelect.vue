...
const props = withDefaults(
    ...
    { placeholder: '', filter: false, filterPlaceholder: '' },
)
...
<template>
    <PopoverRoot>
        <PopoverTrigger
            v-bind="$attrs"
            class="inline-flex h-10 min-w-0 items-center justify-between gap-2 rounded-lg border border-border-one bg-bg-two px-3 text-base outline-none hover:bg-surface-hover focus-visible:ring-2 focus-visible:ring-accent"
            :class="model.length > 0 ? 'text-text-color' : 'text-text-color-secondary'"
        >
