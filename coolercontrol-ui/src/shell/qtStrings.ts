...
export const QT_STRING_KEYS = [
    ...
    'wizard.savedLabel',
    'wizard.addConnection',
    'wizard.addConnectionTooltip',
...
export function buildQtStrings(t: Translate): Record<string, string> {
    return {
        ...
        'wizard.addConnection': t('desktop.wizard.addConnection'),
        'wizard.addConnectionTooltip': t('desktop.wizard.addConnectionTooltip'),
