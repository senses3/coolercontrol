...
export default class DaemonClient {
    ...
    /**
     * The paste-ready hardware support report. Generated by the daemon, which
     * is the only thing that can enumerate liquidctl devices safely. `full`
     * adds the whole hwmon tree; the compact default is trimmed to stay
     * pasteable.
     */
